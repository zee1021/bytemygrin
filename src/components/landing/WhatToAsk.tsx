    ...
    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-background to-muted/20">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="group relative">
                <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border 
                border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl flex items-center 
          ...
          <div className="bg-gradient-to-br pt-45">
            <div className="flex items-center py-2 justify-center h-full">
              <Image
                ...
                width={800}
                height={800}
                className="w-full h-auto max-w-lg object-contain scale-125"
              />
            </div>
          </div>
        </div>
