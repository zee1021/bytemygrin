          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <Button
                size="lg"
                variant="outline"
                className="px-6 py-3 font-semibold bg-gradient-to-r from-primary to-primary/90 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 rounded-xl"
              >
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative">
                ...
                <Image
                  src="/cta.png"
                  alt="ByteMyGrin AI Assistant"
                  width={600}
                  height={600}
                  className="relative w-80 h-auto drop-shadow-xl hover:scale-105 transition-transform duration-500 scale-125"
                  priority
                />
              </div>
